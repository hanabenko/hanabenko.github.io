...
sections:
  - heading: "Intro"
    content: |
      This one’s for my dad, who’d like to analyze the way I write and see if it has a sort of algorithmic approach to it. 
  ...
  - heading: "Body paragraphs (usually 3-5)"
    content: |
      - The goal of the body paragraphs is to establish your credibility and evidence on your side. This appeals to logos (logical evidence) and ethos (your word as an authority on the topic at hand)
      - Start with a 10-15 word topic sentence. This defines what this particular paragraph is about. An example topic sentence is: Bitcoin prices have historically been on a long-term rise.
  ...
  - heading: "Conclusion paragraph"
    content: |
      - 3-5 sentences long
      - Should summarize your key points in the first two sentences
      - The last 2-3 sentences should be a “lesson” for your readers, basically instructing them on what they should take away from this article, what to tell their friends, what to do, etc.
      - A punchy ending is good most of the time, but may not always be appropriate depending on the tone of the rest of the essay
---
